-- Script CORRIGIDO para criar a tabela de pagamentos a receber
-- Criado automaticamente quando relatório muda para "aguardando pagamento"
-- CORREÇÃO: Removida referência a co.cnpj que não existe na tabela companies
...
-- View para facilitar consultas com dados relacionados (CORRIGIDA)
...
SELECT
    ...
    -- Dados da empresa (interna ou terceira) - CORRIGIDO
    CASE 
