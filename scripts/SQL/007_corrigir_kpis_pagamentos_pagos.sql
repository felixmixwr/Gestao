-- =============================================
-- CORREÇÃO DOS KPIs - PAGAMENTOS PAGOS
-- =============================================
...
SELECT
    ...
    (
        -- Contar pagamentos pagos: tanto da tabela pagamentos_receber quanto relatórios PAGO sem pagamento
    ...
    (
        -- Somar valores pagos: tanto da tabela pagamentos_receber quanto relatórios PAGO sem pagamento
...
SELECT
    -- Gerar ID único para relatórios sem pagamento
    r.id::text || '_relatorio' as id,
