-- Script SQL SIMPLES para criar a tabela pumps
...
-- 3. Adicionar coluna total_value à tabela reports se não existir
ALTER TABLE reports 
ADD COLUMN IF NOT EXISTS total_value DECIMAL(12,2) DEFAULT 0.0;

-- 4. Criar índices na tabela reports
...
-- 9. Inserir algumas bombas de exemplo (usando empresas específicas)
