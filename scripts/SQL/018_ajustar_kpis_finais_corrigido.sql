-- =============================================
-- AJUSTE FINAL DOS KPIs - VERSÃO CORRIGIDA
-- =============================================
-- Este script corrige o erro de mudança de nome de coluna da view
...
COMMENT ON VIEW view_kpis_financeiros_unificados IS 'View recriada com KPIs conforme especificação: Total bombeamentos, Aguardando pagamento, Relatórios pendentes';
